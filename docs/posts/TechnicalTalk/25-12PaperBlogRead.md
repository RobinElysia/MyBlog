...
&emsp;37. [永久性化学品的时代终将结束吗？Is There an End to Forever Chemicals?](https://cacm.acm.org/news/is-there-an-end-to-forever-chemicals/)
> 1. 如今，超过15,000种全氟烷基和多氟烷基物质（PFAS）被用于生产超过39,000种电子元件，其中包括半导体、导线、电缆、电池、电阻器和印刷电路板。寻找安全且价格合理的替代品极其困难，而与此同时，对高性能芯片的需求却在持续增长。
> 2. PFAS并非近期才出现的物质。早在20世纪30年代末，曼哈顿计划的科学家们就发现某些化学物质具有优异的绝缘性能。自20世纪50年代以来，制造商已将PFAS广泛应用于各种产品中，包括不粘锅、服装、地毯、家具、消防泡沫和食品包装。其吸引力显而易见：这类化合物具有防火、防水和防污的特性。“PFAS极其稳定，是生产多种产品的理想材料，”Chien说道。
> 3. 如何处理 PFAS 废弃物，其年产量可能超过一百万吨（1 兆吨）。由于芯片制造商使用多种工艺并依赖多种不同的 PFAS，因此几乎不可能收集到半导体行业的准确数据。但全球可持续发展公司 ADEC Innovations 的一份报告指出，电子产品制造中使用的 PFAS 中有 5% 到 25% 最终会进入环境。
> 4. 贝克解释说。“当我们检查动物时，我们发现从北卡罗来纳州的鱼片到北极的北极熊，各种生物体内都存在 PFAS 的生物累积。我们甚至在人类母乳中也发现了 PFAS。”
> 5. 短链 PFAS 比长链 PFAS 更难、成本更高地从环境中清除。
> 6. 由于 PFAS 中的碳氟键化学性质稳定且难以燃烧，不完全焚烧会导致毒素直接释放到环境中。研究人员发现，即使在 850 摄氏度的高温下，仍有 1% 的 PFAS 无法被破坏。